...
export default function Mainpage() {
  ...
  return (
    <>
      <nav id="nav-bar">
        <h1 id="fakestore">Seriously FakeStore</h1>
        <ul>
          <li>
            <Link to="/signinpage">
      ...
      <div id="topimg">
        <div id="ff">
          {/* <h1 id="shop" style={{ fontSize: '32px', color: 'white' }}>
            Shop millions of top-quality products at unbeatable prices! From
          ...
          .map((data) => (
            <div id="imagecart" key={data.id}>
              ...
              <div id="productinfo">
                ...
                <button id="btn1" className="shopbtns" onClick={adding}>
                  Add to Cart
                </button>
                <button id="btn2" className="shopbtns">
                  Buy Now
                </button>
              </div>
            </div>
